...
[[Aspect]]
# SETUP
https://docs.google.com/document/d/1uwNY9Aygfw3faaVACHvybAd2uBQjsGyPCE_HKPebfKg/edit#heading=h.mtmzr9gwvvjv
http://forum.homestuck.xyz/viewtopic.php?p=18620
https://mspaintadventures.fandom.com/wiki/Sburb

- figure out how to do stuff as dm
	- how to play
	- sprites
...
- speed
	- defence
	- movement
	- reflex-based skill checks
- smarts
	- insight
	- alchemizing
	- puzzle-solving
	- knowledge-based skill checks
- soul (aspect powers, consort handling)
	- aspect powers
	- consort handling

Base skill set is 3D4+1D6 (distributed by choice)
To level up your skill die, you'll need to:
- strength: alchemizing new weapons
- speed: alchemizing new clothes
...
**Sylladex:** Your inventory system. This is based on sorting methods in coding, but does not strictly follow those rules. There are lots of modi available, so you can go ham on the system! The general rule is that it has to be at least slightly inconvenient to use, so choose wisely.
### Helpful sources:
